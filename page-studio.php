  ...
  <div id="carouselDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" data-bs-interval="10000">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/studio/studio_main1.jpg" class="d-block w-100">
      </div>
      <div class="carousel-item" data-bs-interval="2000">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/studio/studio_main2.jpg" class="d-block w-100">
      </div>
      <div class="carousel-item">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/studio/studio_main3.jpg" class="d-block w-100">
      </div>
    </div>
    <div class="studio__slidelogo">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/studio/logo_studio.png">
    </div>
  </div>
